...
\affil[2]{\orgdiv{Department of Mechanical Engineering}, \orgname{American University of Beirut}, \orgaddress{\street{P.O. Box 11-0236, Riad El-Solh}, \city{Beirut}, \postcode{1107 2020}, \state{Beirut}, \country{Lebanon}}}
...
\keywords{Tree-based data representation, Structure Discovery, Semantic representation, Embedding-based analysis, Textual data analysis, Unsupervised learning, Density-based clustering, Hierarchical clustering}
