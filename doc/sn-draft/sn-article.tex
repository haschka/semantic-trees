...
\title[Article Title]{Semantic Tree Inference on Text Corpa using a Nested Density Approach together with Large Language Model Embeddings}
...
\author*[1]{\fnm{Thomas} \sur{Haschka}}\email{thomas.haschka@tuwien.ac.at}

\author[2]{\fnm{Joseph} \sur{Bakarji}}\email{jb50@aub.edu.lb}

\author[1,2]{\fnm{Third} \sur{Author}}\email{iiiauthor@gmail.com}
\equalcont{These authors contributed equally to this work.}

\affil*[1]{\orgdiv{E020-04 Service Unit of High Performance Computing, DataLab, Campus IT}, \orgname{Technische Universit{\"a}t Wien}, \orgaddress{\street{Operngasse 11}, \city{Vienna}, \postcode{1040}, \state{Vienna}, \country{Austria}}}

\affil[2]{\orgdiv{Department}, \orgname{American University of Beirut}, \orgaddress{\street{Street}, \city{Beirut}, \postcode{10587}, \state{State}, \country{Lebanon}}}
...
\keywords{Tree-based data represenation, Structure Discovery, Semantic representation, Embedding-based analysis, Textual data analysis, Unsupervised learning, Density-based clustering, Hierachical clustering}
...
\begin{figure}
  \includegraphics[scale=0.8]{tree-from-space.eps}
...
subjects, relate to one another within a coherent hierarchical framework. 
...
\begin{figure}
  \begin{center}
    \includegraphics{annotation-schema.eps}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.8]{comparision-cos-L2.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{20-newsgroups.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{50-pos-neg.eps}
...
\begin{figure*}
  \begin{center}
    \includegraphics[scale=0.8]{ag_news.eps}
...
social-science and humanities clade, numerous small and weakly
...
\begin{figure*}
  \begin{center}
    \includegraphics[scale=0.8]{theses.eps}
    \caption{Tree generated from the French Theses theses-fr-en
      dataset:\newline
      A: Coloration according to binary classification Humanities and
      Natural Sciences. \newline
      B: Coloration according to the main groups of the OECD FOS
      classification. \newline
      C: Highlight of the subgroups of the Natural Sciences group
...
\item  American University of Beirut (AUB)

  At the American University of Beirut, medicine and health-related
  ...
  the largest and most cohesive clade. Within this region, several
  ...
  A distinct humanities clade is also present, characterized by numerous
  subbranches labeled as Middle Eastern Studies and Conflict
  Resolution. In addition, an engineering clade—covering engineering,
  physics, and mathematics—is clearly visible. Notably, this engineering
  clade merges with the humanities clade at a higher density than with the
  medical clade, suggesting a closer structural relationship between
  engineering and humanities research topics within this corpus than might
  be expected.

  To the left of these major clades, smaller clusters related to both
  engineering and humanities fields branch into the tree and eventually
  merge with the broader medical clade. Beyond this point, several
...
\item Technische Universität Wien (TU Wien)
  ...
  Nevertheless, the tree reveals several large and meaningful clades that
  highlight the institution’s disciplinary strengths.
  
  At the upper right of the tree, we observe a clade corresponding to
  quantum mechanics, quantum optics, and quantum-scale materials.
  This region merges smoothly into a broad materials science clade,
  which occupies much of the upper left quadrant of the circular tree.
  
  Also in the upper left quadrant is a large clade corresponding to
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{aub-tree.eps}
    \caption{Tree generated from the AUB dataset.}
    \label{fig-aub-tree}
  \end{center}
\end{figure}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{tuwien-tree.eps}
    \caption{Tree generated from the TU Wien dataset.}
...
Herein we outline our hierachical density based tree construction
...
The benchmark datasets provide a reference for the applicapability of
our method.
...
political discussions. The hirachical approach further uncovered that
sports related discussions are furhter elongated from the different
groups only merging to the whole tree close its root.

The AG news dataset similarly shows that World and Sports articles
form well separated clades, but that Business and Science/Technology
...
these are rather abitrarly chosen and unstandarized. We transcribed
...
of labeled humanities formed a clear clade in our tree. Encouraged by
these findings we prograssed to transcribe the ``discipine'' labels
into the OECD FOS annotation. We colored the tree according to it and
found thanks to the hirachical structure that engineering and medical
sciences merge earlier than either social sciences or humanities. A
relationship that as such can not be derived from the FOS
...
These observations support the idea that our tree-based represenations can
serve a serve as a complementary, data-driven alternative to
tranditional classification schemes.
...
dispersed accross the inferred tree, outlining the limitations of our
approach, where the embeddings as outlined here do not encode as here
sentiment or an other required topic separator.   

\subsection{Insititution-Specific Research Landscapes}
...
manifests as a large, cohesive clade branching into public health,
nutrition, epidemiology, and related fields. The emergence of a
well-defined humanities clade, in particularl in Middle Eastern Studies
...
with prominent clades in materials science, quantum physics, information
...
constraints of long-context inference. Nonetheless, even imperfect
