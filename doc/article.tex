...
\begin{figure*}
  ...
  \end{center}
\end{figure*}
We observe that the \emph{World} and \emph{Sports} categories form
...
The remaining two categories—\emph{Business} and \emph{Science/Technology}—show
...
embedding models that we are using here. Further business headlines
